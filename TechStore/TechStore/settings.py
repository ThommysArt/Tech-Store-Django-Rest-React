...
SECRET_KEY = 'django-insecure-r!@q%&yz3^+p9q$b&&b*d5erbx&4)^xlidrgp$*1ep9@2#$&+8'
...
STATIC_URL = os.path.join(BASE_DIR, 'frontend', 'src/')
...
# MEDIA_ROOT = "TechStore/frontend/static/ASSETS/"
